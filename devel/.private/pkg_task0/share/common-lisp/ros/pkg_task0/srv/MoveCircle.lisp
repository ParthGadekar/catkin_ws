...
(cl:defmethod cl:initialize-instance :after ((m <MoveCircle-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveCircle-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pkg_task0-srv:<MoveCircle-request> is deprecated: use pkg_task0-srv:MoveCircle-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <MoveCircle-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveCircle-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pkg_task0-srv:<MoveCircle-response> is deprecated: use pkg_task0-srv:MoveCircle-response instead.")))
